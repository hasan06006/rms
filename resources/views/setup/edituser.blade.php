    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{url('/edituser/'.$users->id)}}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">                           
                                <select class="form-control @error('role_name') is-invalid @enderror" name="role_name" id="role_name" required >                               
                                    <option value="Admin" @if($users->role_name==='Admin') selected='selected' @endif >Admin</option> 
                                    <option value="User" @if($users->role_name==='User') selected='selected' @endif > User </option>                                 
                                </select>                            
